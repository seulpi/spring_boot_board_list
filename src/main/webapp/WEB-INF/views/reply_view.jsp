...
<body text="center">
	...
	<div class="container">
		...
		<form action="${pageContext.request.contextPath}/board/reply" method="post">
			...
			<input type="hidden" name="bId" value="${reply_view.bGroup}">
			<input type="hidden" name="bId" value="${reply_view.bStep}">
			<input type="hidden" name="bId" value="${reply_view.bIndent}">
